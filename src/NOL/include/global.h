 ...
 */
	...
	public:
		...
		ConjugateGradientType conjugate_gradient_type = ConjugateGradientType::DY;
		unsigned int conjugate_gradient_restart_num = 5;
	...
	public:
		...
		FLOAT parameter_line_search_wolfe_sigma = 0.4;
